...
const UserToolTextAndFont = (props:any)=> {
  ...
  return (
      <ThemeProvider theme={theme}>
          ...
          {ModalLogic('Annotation Font 변경',annotationFontModal,annotationFontChange,handleCloseButton,'annotation',annotationFont,setAnnotationFontDataStorage)}
          {ModalLogic('Overlay Font 변경',overlayFontModal,overlayFontChange,handleCloseButton,'overlay',overlayFont,setOverlayFontDataStorage)}
          {ModalLogic('Text Marker 변경',textMarkerModal,textMarkerChnage,handleCloseButton,'textMarker',textMarker,setTextMarkerDataStoarge)}
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    {Object.keys(textMarker).map((v:any,i:number)=> {
                                        return (
                                            <TableRow key={i}>
                                                <TableCell>{textMarker[v]}</TableCell>
                                            </TableRow>
                                        )
                                    })}
                                </TableBody>
