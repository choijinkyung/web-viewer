...
import { AddGroupPrivilegeCss } from './styles';
import {
  Box,
  Button,
  Divider,
...
export const AddGroupPrivilege = () => {
  ...
  const AddUser = useCallback(async() => {
    ...
    if (form && form.user_id && form.user_name && form.password) {
      await call.post(`/api/v1/user`, form,t('TID02712')).then((res) => {
        alert(res);
  ...
  }, [userID, userName, password,crypt]);
