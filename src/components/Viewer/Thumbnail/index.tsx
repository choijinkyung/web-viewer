...
const Thumbnail = (props: imageURLIndex) => {
  ...
  return (
    <ThumbnailCss onDragStart={dropEnter} draggable={true}>
      <Box
        style={{
          margin: '0',
          padding: '0',
      ...
      >
        {t('TID02361')} : {props.ThunmnailNumber}
        <br />
        Series Description : {imageNotFound ? '' : description !== '' && description}
      </Box>
      <Box
      ...
      >
        {imageNotFound && <img className="image" src={require('@assets/imageNotFound.png').default} />}
      </Box>
    </ThumbnailCss>
  );
};
